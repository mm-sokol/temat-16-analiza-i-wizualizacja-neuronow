...
def run_training_experiment() -> None:
    ...
    std_model = InterpretableMLP(config.INPUT_SIZE, config.HIDDEN_SIZE, config.OUTPUT_SIZE)
    ...
    sparse_model = InterpretableMLP(config.INPUT_SIZE, config.HIDDEN_SIZE, config.OUTPUT_SIZE)
